           ...
           alt="/" 
            ...
            />
             {isLoggedIn === true && role === "user" && (
                 ...
                 <button className='bg-white rounded lg:rounded-full text-red-600 text-4xl lg:text-3xl p-3 flex items-center justify-center' 
                ...
                {isLoggedIn === true && role === "admin" && (
                 ...
                 className='bg-white rounded lg:rounded-full text-4xl text-red-600 lg:text-3xl p-3 flex items-center justify-center'>
                   <FaEdit/>{" "}
