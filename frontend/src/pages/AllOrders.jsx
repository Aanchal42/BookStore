...
const AllOrders = () => {
   ...
   const [userDivData , setuserDivData] = useState();
    ...
    useEffect(()=>{
     const fetch = async() => {
        const response = await axios.get("http://localhost:1000/api/v1/get-all-order",
            {headers}
        )
    ...
    {AllOrders && AllOrders.length>0 && (
         ...
         <h1 className='text-3xl md:text-5xl font-semibold text-zinc-500 mb-8'>
          ...
          {AllOrders.map((items , i)=>(
            <div className='bg-zinc-800 w-full rounded py-2 flex px-4 gap-2 hover:bg-zinc-900 hover:cursor-pointer'>
               <div className='w-[3%]'>
            ...
            <div className='w-[30%] md:w-[16%]'>
                ...
                <div 
                className={`${Options === i ? "block" : "hidden"}`}>
               <select 
               name="status" 
               id="" 
