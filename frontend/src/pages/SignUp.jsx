  ...
  return (
    <div className='h-auto bg-zinc-900 px-12 py-8 flex items-center justify-center'>
       ...
       md:w-3/6 lg:w-2/6'>
          ...
          <div>
               <label htmlFor="" className='block text-zinc-400'>
                Address
                 </label>
               <textarea type="text"
               className='w-full mt-2 bg-zinc-900 text-zinc-100 p-2  outline-none'
           ...
           <button className=' w-full text-white border mt-2 bg-blue-500 p-2 outline-none rounded-xl font-semibold hover:scale-105 hover:shadow-lg transition-all duration-300' onClick={submit}>
            Sign Up
            </button>
           
           <div className='mt-4 text-center'>
             <p className='flex mt-4 items-center justify-center text-zinc-400 font-semibold'>Or</p>
              <p className='mt-2 text-zinc-400'>Already have an account?
                &nbsp;
